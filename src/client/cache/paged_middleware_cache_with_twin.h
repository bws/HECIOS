#ifndef PAGED_MIDDLEWARE_CACHE_WITH_TWIN_H_
#define PAGED_MIDDLEWARE_CACHE_WITH_TWIN_H_
//
...
class PagedMiddlewareCacheWithTwin : public PagedCache
{
public:
    /** Constructor */
    PagedMiddlewareCacheWithTwin();
